...
// only needed if not using tailwind-style emojis

const ChannalMessageInput = ({ refetchMessages }) => {
  ...
  const { sendChannalMessage } = channalStore();
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      await sendChannalMessage(formData);
      setText("");
      removeImage();
      removeVideo();
      removeFile();
...
export default ChannalMessageInput;
