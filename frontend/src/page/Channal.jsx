...
import ChannalMessage from "../components/ChannalMessage";
import { channalStore } from "../store/channalChatStore";
import NoChannalMessage from "../components/NoChannalMessage";
import ChannalDescription from "../components/ChannalDescription";
import ChannalSetting from "../components/ChannalSetting";
import ChannalBar from "../components/ChannalBar";

export default function Channal() {
